"""
Universe Simulator - Pure-Python SHA-256
Original implementation of the SHA-256 compression function (for research only).
"""
...
def _sha256(message: bytes) -> bytes:
    ...
    for i in range(0, len(message), 64):
        w = list(struct.unpack(">16I", message[i:i+64])) + [0] * 48
...
if __name__ == "__main__":
    ...
    print("pure_sha256 self-test passed")
